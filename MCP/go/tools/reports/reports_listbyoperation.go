...
func Reports_listbyoperationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/reports/byOperation%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, queryString)
...
func CreateReports_listbyoperationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_reports_byOperation",
		mcp.WithDescription("Lists report records by API Operations."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Reports_listbyoperationHandler(cfg),
	}
}
